...
parser.add_argument('--mpileup_index', required=True, metavar='file', help='identified candidate somatic sites')
parser.add_argument('--Validated_labels', required=True, metavar='file')
parser.add_argument('--Validated_somatic_sites', required=True, metavar='file')
