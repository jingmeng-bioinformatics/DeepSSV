...
parser.add_argument('--Candidate_validated_somatic_sites', required=True, metavar='Information about candidate or validated somatic sites', help='mapping information about candidate or validated somatic sites')
...
parser.add_argument('--Mapping_information_file', required=True, metavar='input for the CNN model', help='a file with mapping information for candidate or validated somatic small variant sites')
