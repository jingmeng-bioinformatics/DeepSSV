...
parser.add_argument('--Mapping_information_file_train', required=True, metavar='file', help='file for training with mapping information for validated somatic small variant sites')
...
parser.add_argument('--batch_size', default=128, type=int, help='total number of training examples in a single batch')
parser.add_argument('--buffer_size', default=600, type=int, help='the maximum number of elements that will be buffered when prefetching')
parser.add_argument('--num_epochs', default=100, type=int, help='the number of times the model sees the entire dataset')
parser.add_argument('--num_neurons_fc1', default=256, help='the number of neurons in the first fully connected layer')
parser.add_argument('--learning_rate', default=0.001, metavar=' ', help='learning rate for training models')
parser.add_argument('--saved_model_path', required=True, metavar='path', help='the directory to save trained models')
parser.add_argument('--number_of_columns', default=110, required=True, type=int, help='the number of flanking genomic sites to the left or right of the candidate somatic site')
