...
parser.add_argument('--number_of_columns', default=220, type=int, help='the number of flanking genomic sites to the left or right of the candidate somatic site')
